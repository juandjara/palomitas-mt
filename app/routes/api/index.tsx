    ...
    <div className="p-4 my-4 mx-auto max-w-screen-md">
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc ml-4 space-y-2 pb-4">
          ...
          <li><strong>guessit</strong> (si se detecta este par&aacute;metro, se usar&aacute; la biblioteca <a className='text-blue-500 hover:underline' href="https://github.com/guessit-io/guessit" target='_blank' rel='noreferrer'><strong>guessit</strong></a> para extraer la información de los titulos de los torrents en lugar de usar el extractor sencillo basado en regex de Palomitas MT) </li>
